...
{{/*
Combined image pull secrets for the task runners
*/}}
{{- define "graphwise-workflows.runners.combinedImagePullSecrets" -}}
  {{- $secrets := concat .Values.global.imagePullSecrets .Values.runners.image.pullSecrets }}
  {{- tpl (toYaml $secrets) . -}}
{{- end -}}
